 ...
 * 
 * Итеративный constrained-алгоритм. 
 * На каждом шаге возрастной профиль сглаживается гауссовым фильтром, после чего значения внутри каждой агрегированной группы 
 * масштабируются так, чтобы их среднее точно совпадало с исходным значением группы. 
 * Итерации продолжаются до сходимости, что обеспечивает гладкую и неотрицательную однолетнюю реконструкцию при сохранении агрегированных значений.
 */
