 ...
 * для расчёта рождаемости 
 */
public class RosBrisFemalePopulationAverageForBirths
{
    ...
    private static RosBrisDataSet forYear(int year) throws Exception
    {
        if (year >= 2012 && year <= 2022 && use2021census)
        {
            if (ds_2012_2022 == null)
                ds_2012_2022 = RosBrisDataSet.load("RosBRIS/PopBa/PopBa2012-2022.txt");
        ...
        else if (year >= 1989 && year <= 2014)
        {
            if (ds_1989_2014 == null)
                ds_1989_2014 = RosBrisDataSet.load("RosBRIS/PopBa/PopBa1989-2014.txt");
        ...
        else if (year >= 2015 && year <= 2022)
        {
            if (ds_2015_2022 == null)
                ds_2015_2022 = RosBrisDataSet.load("RosBRIS/PopBa/PopBa2015-2022.txt");
