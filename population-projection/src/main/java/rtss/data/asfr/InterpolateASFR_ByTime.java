...
/*
 * ВременнАя интерполяция возрастных коэффициентов плодовитости из годового в суб-годовое разрешение
 * по временной (хронологической, а не возрастной) шкале. 
 */
public class InterpolateASFR_ByTime
{
    /*
