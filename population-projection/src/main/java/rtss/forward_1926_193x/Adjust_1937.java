...
Мы распределяем невязку по мужчинам возраста 19-35 лет так, чтобы достигалось соответствие итогам переписи 1939 года.

Мы также корректируем численность возрастов 0 и 1 соответственно взаимоувязке переписей 1937 и 1939 гг. (АДХ-СССР, стр. 35),
