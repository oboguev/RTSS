...
public class ForwardPopulation_1926_1937 extends ForwardPopulation_1926
{
    ...
    public ForwardPopulation_1926_1937 useADH1926Rates() throws Exception
    {
        use_ADH1926_rates(); 
        return this;
    }
    ...
    public void forward(boolean interpolateMortalityTable, boolean useADHInfantMortalityRate) throws Exception
    {
        ...
        /*
         * Передвижка населения для целых лет с декабря 1926 по декабрь 1936 
         */
        ...
        /*
         * Передвижка населения для части года (с 17 декабря 1926 по 6 января 1937)
         */
