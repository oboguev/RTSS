...
public class PrintHalves
{
    ...
    public static void print(HalfYearEntries<HalfYearEntry> halves) throws Exception
    {
        ...
        Util.out("    нал.дс    = добавочное число смертей в наличном на начало войны населении из-за войны");
        ...
        Util.out("    ферт.фч    = фактическая численность женщин фертильного возраста 15-54");
        Util.out("    ферт.нис  = накопленное число избыточных смертей женщин фертильного возраста 15-54");
        Util.out("");
        Util.out("полугодие нал.ос нал.дс мир.ор фр ферт.оч ферт.фч ферт.нис");
        Util.out("");
