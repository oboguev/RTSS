...
public class Main_old_2
{
    ...
    private void evalDeficit1946() throws Exception
    {
        ...
        out("");
        outk("Предварительная сверхсмертность всего наличного на середину 1941 года населения, по дефициту на начало 1946 года", deficit_total);
    ...
    /*
     * Вычислить ожидаемое число смертей от новых рождений в военное время (фактического числа военных рождений),
