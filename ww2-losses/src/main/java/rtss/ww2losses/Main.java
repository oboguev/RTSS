...
public class Main
{
    ...
    /*
     * Вычислить ожидаемое число смертей от новых рождений в военное время (фактического числа рождений),
     * ожидаемый остаток фактически рождённых с 1941.вт-1945.вт к началу 1946 при детской смертности мирного времени,
     * и дефицит остатка на начало 1946 года из-за возросшей в военное время детской смертности. 
     */
