...
public class Main
{
    ...
    private void evalSummary(PopulationContext allExcessDeathsByAgeAt1946) throws Exception
    {
        ...
        outk("Фактическеое число рождений за время войны (середина 1941 - конец 1945), тыс. чел.", v1);
        ...
        outk("Число избыточных смертей фактически родившихся во время войны (середина 1941 - конец 1945), тыс. чел.", v3);
