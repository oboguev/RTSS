...
public class Main
{
    ...
    private void evalSummary(PopulationContext allExcessDeathsByAgeAt1946) throws Exception
    {
        ...
        outk("Дефицит рожденных после середины 1941 года и выживших к концу 1945 года, сравнительно с условиями мира, тыс. чел.", v);
        ...
        Util.out("");
        outk("Число рождений за время войны (середина 1941 - конец 1945), тыс. чел.", v1);
