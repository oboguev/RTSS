...
public class HalfYearEntry
{
    ...
    /* ожидаемое в условиях мира число рождений в период (от начала до конца периода), по дням */
    ...
    /* действительное число рождений в полугодии, по дням */
    public double[] actual_births_byday;
