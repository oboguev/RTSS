...
public class RSFSR_1940 extends CombinedMortalityTable
{
    public RSFSR_1940() throws Exception
    {
        ...
        Bin[] male_mortality_bins = bins;
        m.put(key(Locality.TOTAL, Gender.MALE), makeSingleTable(bins));
        
        // females total 1940 mortality, АДХ-РСФСР page 169
        bins = Bin.bins(makeBin(0, 225.4),
                        makeBin(1, 4, 53.9),
                        makeBin(5, 9, 6.3),
                        makeBin(10, 14, 3.0),
                        makeBin(15, 19, 3.7),
        ...
        Bin[] female_mortality_bins = bins;
        m.put(key(Locality.TOTAL, Gender.FEMALE), makeSingleTable(bins));
        
        // male population 1940, АДХ-РСФСР page 157
        bins = Bin.bins(makeBin(0, 4, 7429),
                        makeBin(5, 9, 5388),
                        makeBin(10, 14, 6854),
                        makeBin(15, 19, 5117),
                        makeBin(20, 24, 3951),
        ...
        bins = Bin.bins(makeBin(0, 4, 7301),
                        makeBin(5, 9, 5412),
                        makeBin(10, 14, 6917),
                        makeBin(15, 19, 5293),
                        makeBin(20, 24, 4480),
