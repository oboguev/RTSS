...
public class RSFSR_1940 extends CombinedMortalityTable
{
    public RSFSR_1940() throws Exception
    {
        ...
        Bin[] male_mortality_bins = Bin.bins(makeBin(0, 259.8),
                                             makeBin(1, 4, 58.5),
                                             makeBin(5, 9, 7.0),
                                             makeBin(10, 14, 3.1),
                                             makeBin(15, 19, 4.4),
        ...
        Bin[] female_mortality_bins = Bin.bins(makeBin(0, 225.4),
                                               makeBin(1, 4, 53.9),
                                               makeBin(5, 9, 6.3),
                                               makeBin(10, 14, 3.0),
                                               makeBin(15, 19, 3.7),
        ...
        Bin[] male_population_bins = Bin.bins(makeBin(0, 4, 7429),
                                              makeBin(5, 9, 5388),
                                              makeBin(10, 14, 6854),
                                              makeBin(15, 19, 5117),
                                              makeBin(20, 24, 3951),
        ...
        Bin[] female_population_bins = Bin.bins(makeBin(0, 4, 7301),
                                                makeBin(5, 9, 5412),
                                                makeBin(10, 14, 6917),
                                                makeBin(15, 19, 5293),
                                                makeBin(20, 24, 4480),
