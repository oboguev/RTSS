...
public class Territory
{
    ...
    private static void defineAliases()
    {
        ...
        aliases("12 прежних неземских губерний", "12 прежних неземских губ.", 
                "В 12 прежних неземских губ.", "В 12 прежних меземских губ.");
        aliases("34 старо-земских губерний", "34 старо-земских губ.", "В т ч в 34 старо-земских губ.");
        aliases("г. Варшава", "Варшава", "г. Варшава.");
        aliases("Азиатская Россия", "азиатская Россия", "Азиатской России");
        aliases("Империя", "Империи");
        ...
        aliases("Елисаветпольская", "Елизаветпольская", "Елисаветнодьекая", "Елисаветпольскаа", 
                "Елисаветпольсхая", "Елнсаветпольская");
        aliases("Средняя Азия", "Средней Азии");
        ...
        aliases("г. Санкт-Петербург", "г. Петербург", "г. Петроград", "г. С.-Петербург");
        ...
        aliases("Ферганская обл.", "Ферганская");
        ...
        aliases("Остзейские губернии", "остзейские губернии", "остзейских губ.", "остзейских губерний",
                "остзейских", "остзейских губ.", "Остзейские");
        aliases("неземские губернии", "неземск губ.", "неземских губ.", 
                "неземских губерний");
        aliases("земские губернии", "земск губ.", "земских губ.", "земских губерний");
        ...
        aliases("Сахалин", "Остр Сахалин", "Остров Сахалин", "Сахалинская", "Сев Сахалин", "Сев. Сахалин");
        ...
        aliases("Средне-волжский район", "средне-волжском районе");
        aliases("Центральный земледельческий район", "центральн земледел районе", "центральном земледел районе");
        aliases("Юго-западный район", "юго-западный район", "юго-западном районе");
        aliases("Новороссийский район", "новороссийский район", "новороссийском районе");
        ...
        aliases("г. Москва", "г. Моcква");
        aliases("литовский район", "литовском", "литовском р");
        aliases("малороссийский район", "малороссийском районе", "маоороссийском районе");
        aliases("неземские губернии", "неземcких губ.", "неземcких", "неземских");
        aliases("Нижневолжский район", "нижневолжском районе");
        aliases("прибалтийские губернии", "прибалтийск губ.");
        aliases("приуральский район", "приуральском районе", "приурадьек");
        ...
        aliases("Калишская", "Еалишск&я", "К-алишская", "Калипиская");
        aliases("Кавказ", "Кавказе");
        aliases("Карсская обл.", "Карсская");
        aliases("Лифляндская", "ЛиФляндская", "Лифлфяндская", "Лифляанская", "Лифляндсксая", "Лифлянская");
        ...
        aliases("Бакинское градонач", "Бакинское градояан");
        aliases("Келецкая", "Кедецкая");
        aliases("Люблинская", "Люблянская");
        aliases("Седлецкая", "Седлцкая", "Седлевская");
