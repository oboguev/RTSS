...
public class TerritoryNames
{
    ...
    private static void defineAliases()
    {
        ...
        aliases("Средняя Азия", "Средней Азии", "Среднеазиатские области", "Ср.-Азиатских областей", 
                "средне-азиатских областях", "Средне-Азиатских областях", "Средне-азиатских областях", "Средне-Азиатских обл.");
        aliases("Сибирь", "Сибири");
        aliases("Кавказ", "Кавказе", "Кавказа");
        aliases("земские губернии", "земск губ.", "земских губ.", "земских губерний", "земских губерниях", "земские");
        aliases("неземские губернии", "неземск губ.", "неземских губ.",
                ...
                "неземcких губ.", "неземcких", "неземских", "неземские");
        ...
        aliases("привислинские губернии", "привислинские губ.", "привисленских губ.",
                ...
                "привнслинск губ.", "привислинских губерниях", "Привислинские губ.", "привисленских губерниях");
        ...
        aliases("Акмолинская обл.", "Акмолинская", "Акмолинская область");
        aliases("Амурская обл.", "Амурская", "Амурмская", "Амурская область");
        aliases("Астраханская (оседлое население)", "Астраханская оседлое население");
        aliases("Астраханская (кочевники)", "Астраханская кочевники");
        ...
        aliases("Дагестанская обл.", "Дагестанская", "Дагестанская область");
        ...
        aliases("Забайкальская обл.", "Забайкальская", "Забайкальсая", "Бабайкальская", "Забайкальская область");
        aliases("Закаспийская обл.", "Закаспийская", "Закаспийская область");
        aliases("Закатальский окр.", "Закатальский округ");
        aliases("Калишская", "Еалишск&я", "К-алишская", "Калипиская", "Калишcкая");
        aliases("Камчатская обл.", "Камчатская");
        aliases("Карсская обл.", "Карсская", "Карсская область");
        aliases("Келецкая", "Кедецкая", "Келцкая", "Келециая");
        aliases("Ковенская", "Ковенсиая");
        aliases("Кубанская обл.", "Кубанская", "Кубанская область");
        aliases("Лифляндская", "ЛиФляндская", "Лифлфяндская", "Лифляанская", "Лифляндсксая",
                "Лифлянская", "Лифдяндская", "Лифляндскэя");
        aliases("Ломжинская", "Ломжинскаа", "Ломжинокая", "Ловшинская", "Лоижинская");
        aliases("Люблинская", "Люблянская");
        aliases("г. Москва", "г. Моcква", "Москва", "Гор. Москва");
        ...
        aliases("Область войска Донского", "Донскаго в обл.", "Донскаго войска область", "Донская", 
                ...
                "Войска Донского обл.", "Область Войска Донского", "Войска Донскаго", "Земля войска Донскаго",
                "Обл. Войска Донскаго.", "Обл. Войска Донского");

        aliases("Петроковская", "Петрояовская", "ГІетроковская");
        aliases("Плоцкая", "Плоцвая", "Плоцная");
        aliases("Приморская обл.", "Приморская", "Приморекая", "Прим. Вост. Сибири", "Приморская область", "Прим Вост Сиб", "Прим. Вост. Сиб.");
        aliases("Радомская", "Радомекая", "Радомккая", "Радонская", "Раломская");

        aliases("Самаркандская обл.", "Самарканская", "Самаркандская", "Самаркандская область");
        aliases("г. Санкт-Петербург", "г. Петербург", "г. Петроград", "г. С.-Петербург", "С.-Петербург", "Санкт-Петербург", "г. С -Петербург");
        aliases("Сахалин", "Остр Сахалин", "Остров Сахалин", "Сахалинская",
                "Сев Сахалин", "Сев. Сахалин", "Остр. Сахалин", "о. Сахалин", "О-в Сахалин");
        ...
        aliases("Семиреченская обл.", "Семиреченская", "Семириченская", "Семриеченская", "Семвреченская", 
                "Семнреченская", "Сѳмиреченская", "Семиреченская", "Семиреченская область", "Семиречинская");
        aliases("Семипалатинская обл.", "Семипалатинская", "Семипалатинская область");
        aliases("Смоленская", "Смоленсяая");
        aliases("Сыр-Дарьинская обл.", "Сьр-Дарьинская", "Сыр-Дарьинская", "Сыр-Даринская обл.",
                "Сыр-Даринсккая", "Сыр-Дарьинска я", "Сыр-Дарьинская область");
        
        aliases("Терская обл.", "Терская", "Терская область");
        aliases("Тифлисская", "Тисяисская");
        aliases("Томская", "Tомская");
        aliases("Тургайская обл.", "Тургайская", "Тургайсксая", "Тургайская область");
        aliases("Уральская обл.", "Уральская", "У ральская", "Уральская область");
        aliases("Уфимская", "Уфимскя");
        aliases("Ферганская обл.", "Ферганская", "Фергранская", "Ферганская область");
        aliases("Херсонская", "Херссвская");
        aliases("Черноморская", "Черноморский округ");
        aliases("Эстляндская", "Эстляндсхая");
        aliases("Якутская обл.", "Якутская", "Якуткая обл.", "Якутская область");
        aliases("Ярославская", "Ярославская.");
        
        aliases(Taxon.Астраханская_оседлое, "Астраханская оседлое");
        aliases(Taxon.Астраханская_кочевники, "Астраханская кочевники");
    }
