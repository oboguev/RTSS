...
public class TerritoryNames
{
    ...
    private static void defineAliases()
    {
        ...
        aliases("Средняя Азия", "Средней Азии", "Среднеазиатские области", "Ср.-Азиатских областей", 
                "средне-азиатских областях", "Средне-Азиатских областях", "Средне-азиатских областях");
        ...
        aliases("Область войска Донского", "Донскаго в обл.", "Донскаго войска область", "Донская", 
                ...
                "Войска Донского обл.", "Область Войска Донского", "Войска Донскаго");
        ...
        aliases("г. Санкт-Петербург", "г. Петербург", "г. Петроград", "г. С.-Петербург", "С.-Петербург", "Санкт-Петербург");
        aliases("Сахалин", "Остр Сахалин", "Остров Сахалин", "Сахалинская",
                "Сев Сахалин", "Сев. Сахалин", "Остр. Сахалин", "о. Сахалин");
