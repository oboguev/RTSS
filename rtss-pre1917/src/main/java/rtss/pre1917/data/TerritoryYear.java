...
public class TerritoryYear
{
    ...
    public void addValue(String what, Double v) throws Exception
    {
        interceptAddValue(what);
    ...
    public void addValue(String what, Long v) throws Exception
    {
        interceptAddValue(what);
    ...
    private void interceptAddValue(String what)
    {
    }
