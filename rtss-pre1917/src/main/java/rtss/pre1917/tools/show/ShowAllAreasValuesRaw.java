...
public class ShowAllAreasValuesRaw extends ShowAllAreasValues 
{
    public static void main(String[] args)
    {
        ...
        Util.out("");
        Util.out("Данные для Выборгской губернии добавлены по финской статистике.");
        Util.out("");
        ...
        Util.out("Для Выборгской губернии данные получены прогрессивным расчётом от переписи 1897 года");
        Util.out("и по финским сведениям о числе рождений, смертей и миграции.");
