...
public class ExtractDemTransCurves
{
    ...
    private void defineCountries() throws Exception
    {
        ...
        addCountry("Гондурас", 1944, "Гондурас-Колвер-правка");
        ...
        addCountry("Сальвадор", 1942, "Сальвадор-Колвер");
        ...
        c1 = getCountry("Коста-Рика", 1925, "Коста-Рика-Бриньоли-1993");
        ...
        addCountry("Гватемала", 1936, "Гватемала-Колвер"); // ###
