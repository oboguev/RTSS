...
public class EvalMortalityRate
{
    ...
    {
        return eval(mt, p, null);
    }

    public static double eval(final CombinedMortalityTable mt, final PopulationByLocality p, final PopulationForwardingContext fctx) throws Exception
    {
